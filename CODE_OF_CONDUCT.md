...
The Crypto and Gotham projects adopt the **Contributor Covenant
v2.1** as their code of conduct, with project-specific contact
details.

## Our pledge

We pledge to make participation in our community a respectful and
productive experience for everyone, regardless of age, body size,
...
in public spaces (e.g. using an official email address, posting via
...
- **Email:** `conduct@<production-domain>` *(placeholder — provisioning
  tracked alongside the production email)*
