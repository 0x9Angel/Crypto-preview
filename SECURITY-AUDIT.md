...
>
> **Revues depuis mai** : plusieurs revues adverses multi-agents ont été menées. La phrase qui figurait ici — « tous les findings confirmés ont été corrigés » — était fausse et l'est restée. État au 2026-09-12, d'après le registre interne : **71 findings recensés, 46 corrigés et testés, 6 réduits, 19 encore ouverts**, dont **un critique** (le MAC d'en-tête n'authentifie qu'un slot du bloc de routage : deux relais complices peuvent marquer un paquet à l'entrée et le reconnaître à la sortie). Le décompte réel des ouvertes est **entre 19 et 31** : douze findings de la campagne de juillet n'ont jamais été reversés dans le registre. Il n'y a **toujours PAS d'audit externe / tiers indépendant**.
>
